-- @description ek_Monitoring FX Watcher (custom slot)
-- @author Ed Kashinsky
-- @noindex
-- @about This script monitors a certain fx slot in the monitoring chain and switches the bypass on it in realtime
-- @readme_skip
...
xpcall(function()
	...
	EK:Watcher_ToggleSlot(EK.SLOT_CUSTOM)
end, function(err)
