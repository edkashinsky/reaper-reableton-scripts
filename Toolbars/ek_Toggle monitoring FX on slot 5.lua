-- @description ek_Toggle monitoring fx plugin on slot 5
-- @version 1.0.0
-- @author Ed Kashinsky
-- @about
...
GA_ToggleMfxBtnOnSlot(ga_mfx_slots.mfx_slot_5, ga_highlight_buttons.mfx_slot_5, sectionID, cmdID)

reaper.Undo_EndBlock("Toggle monitoring fx plugin on slot 5", -1)