...
--   [main=main] ek_Monitoring FX Watcher (slot 2).lua
--   [main=main] ek_Monitoring FX Watcher (slot 3).lua
--   [main=main] ek_Monitoring FX Watcher (slot 4).lua
--   [main=main] ek_Monitoring FX Watcher (slot 5).lua
--   [main=main] ek_Monitoring FX Watcher (custom slot).lua
...
xpcall(function()
	if not CoreLibraryLoad("core") or not CoreLibraryLoad("mon-fx-watcher") then
