-- @description ek_Toggle monitoring fx plugin on slot 2
-- @version 1.0.1
-- @author Ed Kashinsky
-- @about
...
GA_ToggleMfxBtnOnSlot(ga_mfx_slots.mfx_slot_2, ga_highlight_buttons.mfx_slot_2, sectionID, cmdID)

reaper.Undo_EndBlock("Toggle monitoring fx plugin on slot 2", -1)