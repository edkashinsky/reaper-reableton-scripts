...
--
--   Work with script ek_Pitch Tool - Switch to prev pitch mode for selected items.lua
-- @noindex
-- @readme_skip
...
local function getNextPitchMode(ind)
...
if item ~= nil then
	...
	local newMode = getNextPitchMode(mode)
...
reaper.Undo_EndBlock("Switch to next pitch mode for selected items", -1)